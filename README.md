...
`falconsai-surgeon` is the thin client for that server. It holds no server code and depends on one library (`cryptography`, for the verifier's ed25519 check). Version 7.72.
